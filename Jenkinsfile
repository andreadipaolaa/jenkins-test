    ...
    stages {
        ...
        stage('kubernetes-deploy'){
            steps {
                ...
                sh 'az aks command invoke --resource-group rg-poclot-dev-gwc-aks --name aks-poclot-dev-gwc-lotto --command "kubectl rollout restart deployment/gms-deployment -nmd 1" --output table'
            }
        }
    }
}
